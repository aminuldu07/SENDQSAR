...
#
#   # Call the function
#   result <- get_mi_score(studyid, path_db, fake_study, master_CompileData, score_in_list_format)
#
...
#   expect_error(get_mi_score(NULL, path_db, fake_study))
#   expect_error(get_mi_score("invalid_study", "wrong/path", fake_study))
#})
