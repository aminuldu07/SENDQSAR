...
#
#   # Call the function
#   result <- get_bw_score(studyid, path_db, fake_study, master_CompileData, score_in_list_format)
#
...
#   expect_error(get_bw_scor(NULL, path_db, fake_study))
#   expect_error(get_bw_scor("invalid_study", "wrong/path", fake_study))
# })
