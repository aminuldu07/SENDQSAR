...
- **Core Functions**:  
  Functions `f1` to `f12` are essential components, each designed to fulfill a specific role in the overall process.

- **Function Dependencies**:  
  - **Function `f6`**: Aggregates outputs from `f1`, `f2`, `f3`, `f4`, and `f5` to produce a data frame.  
  - **Function `f7`**: Utilizes the output from `f6` to generate a new data frame.  
  - **Function `f8`**: Processes the output from `f7` to create another data frame.  
