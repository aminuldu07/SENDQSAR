...
train_and_evaluate_rf_model <- train_eval_rf_with_cv_imp(scores_df=NULL,
                                                         path_db = path_db, # need when scores_df is NULL and need to calculate it
                                                         ...
                                                         testReps=1, # testRps must be at least 2;
